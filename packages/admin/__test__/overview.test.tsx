...
import { APPS, devicesFixture, emptyOverview, mockStatsFetch, overviewFixture, pagesFixture, filtersFixture, pageProps } from './fixtures'
...
describe('概览板块', () => {
  it('渲染 6 张 KPI 与环比', async () => {
    ...
    render(<Overview filters={filters} {...pageProps} />)
...
describe('页面板块', () => {
  it('渲染路径、入口与来源三张表', async () => {
    ...
    render(<Pages filters={filters} {...pageProps} />)
